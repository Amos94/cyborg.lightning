...
/**
 * Created by Simeon on 19/03/2016.
 */
public class testRegistrationDateAssistant {

    public testRegistrationDateAssistant(){

    }

    public static boolean testParseDateAssistant(String date) throws ParseException {
        int age;
