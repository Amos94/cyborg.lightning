...
public class testDateVerification {
    ...
    public void testDateValidity1() throws ParseException{
        assertTrue(inputVerification.DoBVerification("20/12/1990"));
    }

    /*Tests under 18 years of age*/
    @Test //Test 1
    public void testDateValidityUnderAge1() throws ParseException{
        assertFalse(inputVerification.DoBVerification("20/12/2002"));
    }

    @Test //Test 2
    public void testDateValidityUnderAge2() throws ParseException{
        assertFalse(inputVerification.DoBVerification("12/04/2003"));
    }

    @Test //Test 3
    public void testDateValidityUnderAge3() throws ParseException{
        assertFalse(inputVerification.DoBVerification("31/10/1999"));
    }
   ...
   /*Test NULL INPUT - Test Fail - NullPointerException*/
    ...
    public void testDateValidityCheckDigits() throws ParseException {
        assertTrue(inputVerification.DoBVerification("11/11/1111"));
    }
    ...
    public void testDateValidityCheckIllogicalInput()throws ParseException {
        assertTrue(inputVerification.DoBVerification("01/02/0000"));
    }
    ...
    public void testDateSQL1() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(0)));
    }

    /* "'or 1=1" input - SQL injection Test*/
    @Test
    public void testDateSQL2() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(1)));
    }

    /* ""or 1=1" input - SQL injection Test*/
    @Test
    public void testDateSQL3() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(3)));
    }
    ...
    public void testDateSQL5() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(4)));
    }

    /* ""or 1=1-" input - SQL injection Test*/
    @Test
    public void testDateSQL6() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(5)));
    }

    /* "or 1=1#" input - SQL injection Test*/
    @Test
    public void testDateSQL7() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(6)));
    }

    /* "'or 1=1#" input - SQL injection Test*/
    @Test
    public void testDateSQL8() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(7)));
    }

    /* ""or" input - SQL injection Test*/
    @Test
    public void testDateSQL9() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(8)));
    }

    /* "1=1#" input - SQL injection Test*/
    @Test
    public void testDateSQL10() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(9)));
    }

    /* "or 1=1/*" input - SQL injection Test*/
    @Test
    public void testDateSQL11() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(10)));
    }

    /* "'or 1=1/*" input - SQL injection Test*/
    @Test
    public void testDateSQL12() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(11)));
    }

    /* ""or 1=1/ input - SQL injection Test*/
    @Test
    public void testDateSQL13() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(12)));
    }

    /* "or 1=1;%00" input - SQL injection Test*/
    @Test
    public void testDateSQL14() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(13)));
    }

    /* "or 1=1" input - SQL injection Test*/
    @Test
    public void testDateSQL15() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(14)));
    }

    /* "'or'" input - SQL injection Test*/
    @Test
    public void testDateSQL16() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(15)));
    }

    /* "'or" input - SQL injection Test*/
    @Test
    public void testDateSQL17() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(16)));
    }

    /* "'or'-" input - SQL injection Test*/
    @Test
    public void testDateSQL18() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(17)));
    }

    /* "'or-"  input - SQL injection Test*/
    @Test
    public void testDateSQL19() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(18)));
    }

    /* "or a=a" input - SQL injection Test*/
    @Test
    public void testDateSQL20() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(19)));
    }

    /* "'or a=a" input - SQL injection Test*/
    @Test
    public void testDateSQL21() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(20)));
    }

    /* ""or a=a" input - SQL injection Test*/
    @Test
    public void testDateSQL22() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(21)));
    }

    /* "or a=a-" input - SQL injection Test*/
    @Test
    public void testDateSQL23() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(22)));
    }

    /* "'or a=a" input - SQL injection Test*/
    @Test
    public void testDateSQL24() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(23)));
    }

    /* ""or a=a" input - SQL injection Test*/
    @Test
    public void testDateSQL25() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(24)));
    }

    /* "or a=a-" input - SQL injection Test*/
    @Test
    public void testDateSQL26() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(25)));
    }

    /* "'or a=a-"; input - SQL injection Test*/
    @Test
    public void testDateSQL27() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(26)));
    }

    /* ""or a=a-" input - SQL injection Test*/
    @Test
    public void testDateSQL28() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(27)));
    }

    /* "or 'a'='a'"  input - SQL injection Test*/
    @Test
    public void testDateSQL29() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(28)));
    }

    /* "'or 'a'='a'" input - SQL injection Test*/
    @Test
    public void testDateSQL30() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(29)));
    }

    /* ""or 'a'='a'"  input - SQL injection Test*/
    @Test
    public void testDateSQL31() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(30)));
    }

    /* "')or('a'='a'" input - SQL injection Test*/
    @Test
    public void testDateSQL32() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(31)));
    }

    /* "")"a"="a"" input - SQL injection Test*/
    @Test
    public void testDateSQL33() throws ParseException{
        assertFalse(inputVerification.DoBVerification(sqlStrings.getSQLibyID(32)));
    }
